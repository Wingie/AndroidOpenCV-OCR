...
public class CameraScreen extends Activity implements CvCameraViewListener2 {
    ...
    public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
        ...
        switch (CameraScreen.viewMode) {
        case CameraScreen.VIEW_MODE_RGBA:
            break;

        case CameraScreen.VIEW_MODE_HIST:
        ...
        case CameraScreen.VIEW_MODE_CANNY:
        ...
        case CameraScreen.VIEW_MODE_SOBEL:
        ...
        case CameraScreen.VIEW_MODE_SEPIA:
        ...
        case CameraScreen.VIEW_MODE_ZOOM:
        ...
        case CameraScreen.VIEW_MODE_PIXELIZE:
            if ((mRgbaInnerWindow == null) || (mRgba.cols() != mSizeRgba.width) || (mRgba.height() != mSizeRgba.height))
                CreateAuxiliaryMats();
        ...
        case CameraScreen.VIEW_MODE_POSTERIZE:
            if ((mRgbaInnerWindow == null) || (mRgba.cols() != mSizeRgba.width) || (mRgba.height() != mSizeRgba.height))
                CreateAuxiliaryMats();
            /*
